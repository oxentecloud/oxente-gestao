	...
	<body>
		...
		<div id="show-tipoDocumento" class="content scaffold-show" role="main">
			...
			<ol class="property-list tipoDocumento">
				...
				<g:if test="${tipoDocumentoInstance?.descricao}">
				<li class="fieldcontain">
					<span id="descricao-label" class="property-label"><g:message code="tipoDocumento.descricao.label" default="Descricao" /></span>
					
						<span class="property-value" aria-labelledby="descricao-label"><g:fieldValue bean="${tipoDocumentoInstance}" field="descricao"/></span>
