			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="descricao" title="${message(code: 'conta.descricao.label', default: 'Descricao')}" />
				...
				<g:each in="${contaInstanceList}" status="i" var="contaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${contaInstance.id}">${fieldValue(bean: contaInstance, field: "descricao")}</g:link></td>
