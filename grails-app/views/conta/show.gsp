	...
	<body>
		...
		<div id="show-conta" class="content scaffold-show" role="main">
			...
			<ol class="property-list conta">
				...
				<g:if test="${contaInstance?.descricao}">
				<li class="fieldcontain">
					<span id="descricao-label" class="property-label"><g:message code="conta.descricao.label" default="Descricao" /></span>
					
						<span class="property-value" aria-labelledby="descricao-label"><g:fieldValue bean="${contaInstance}" field="descricao"/></span>
